...
const config: Config = {
  ...
  organizationName: 'zhangyan-didu', // Usually your GitHub org/user name.
  projectName: 'zhangyan-didu.github.io', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/zhangyan-didu/zhangyan-didu.github.io/tree/main/',
        },
        blog: {
          remarkPlugins: [remarkMath],
          rehypePlugins: [rehypeKatex],
